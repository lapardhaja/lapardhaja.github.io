...
test('publishes concise, indexable portfolio metadata', () => {
  ...
  assert.match(html, /<meta property="og:image:alt" content="Servet Lapardhaja, Ph\.D\., P\.E\. — AI Engineer and transportation researcher">/)
  assert.match(html, /<meta property="og:title" content="Servet Lapardhaja, Ph\.D\., P\.E\. \| AI Engineer at the U\.S\. Treasury">/)
  assert.match(html, /<meta name="twitter:image:alt" content="Servet Lapardhaja, Ph\.D\., P\.E\. — AI Engineer and transportation researcher">/)
